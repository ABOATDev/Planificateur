...
def index(request):
    ...
    temp=Template(formulaire+"<br><a href='tache'>Afficher la liste des tâches</a><br><br><a href='personne'>Afficher la liste des personnes</a><br><br><a href='projet'>Afficher la liste des projets</a>")
